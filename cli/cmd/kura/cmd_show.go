...
import (
	...
	"github.com/wyvernzora/kura/cli/internal/cli/prompt"
...
type showCmd struct {
	...
	Status     []string `name:"status" help:"Repeatable. Restrict to episodes whose status is in this set (pending, missing, present, unavailable, staged)."`
