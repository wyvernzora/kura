 ...
 * `internal/response/*.go`; see [./types.gen.ts](./types.gen.ts).
 *
 * What lives here vs. there:
 *
 *   - generated: every response struct in `internal/response`. Edit
 ...
 * `internal/server/rest/errors.go`, not in `internal/response/`.
 */
