...
Returns the resolved `ref`, sanitized series `directory`, and provider `preferredTitle`.
...
- `directory` (string, optional) — override for the on-disk directory name. Defaults to a sanitized form of the provider's preferred title.
