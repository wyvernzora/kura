...
func TestGet_RunningEntryReportsRunning(t *testing.T) {
	...
	j := jobs.Submit(r, context.Background(), jobs.KindScan, mustSeries(t, "view-a"), func(ctx context.Context) (int, error) {
		<-finish
		return 0, nil
	})
	view, err := r.Get(j.ID())
...
func TestGet_TerminalSuccessExposesEncodedResult(t *testing.T) {
	...
	j := jobs.Submit(r, context.Background(), jobs.KindScan, mustSeries(t, "view-b"), func(ctx context.Context) (payload, error) {
		return want, nil
	})
	j.Wait(context.Background())
...
func TestGet_TerminalFailureExposesError(t *testing.T) {
	...
	j := jobs.Submit(r, context.Background(), jobs.KindScan, mustSeries(t, "view-c"), func(ctx context.Context) (int, error) {
		return 0, want
	})
	j.Wait(context.Background())
...
func TestReaper_EvictsTerminalPastRetention(t *testing.T) {
	...
	j := jobs.Submit(r, context.Background(), jobs.KindScan, mustSeries(t, "view-d"), func(ctx context.Context) (int, error) {
		return 1, nil
	})
	j.Wait(context.Background())
...
func TestReaper_PreservesRunningJobs(t *testing.T) {
	...
	finish := make(chan struct{})
	j := jobs.Submit(r, context.Background(), jobs.KindScan, mustSeries(t, "view-e"), func(ctx context.Context) (int, error) {
		<-finish
		return 0, nil
	})
