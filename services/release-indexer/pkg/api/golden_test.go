		...
		"claim": api.ClaimResponse{
			Items: []api.ClaimItem{{
				...
				Precedents: []api.ClaimPrecedent{{
					...
					Reason:      nil,
					Similarity:  0.87,
					PublishedAt: ts("2026-07-20T12:34:56.123456Z"),
				}, {
					Infohash:    "76543210fedcba9876543210fedcba9876543210",
					Title:       "[OtherGroup] Example - 00 (Raw 1080p)",
					MatchStatus: api.MatchStatusSuppressed,
					Ref:         nil,
					Reason:      ptr("raw, superseded by the subbed release"),
					Similarity:  0.61,
