...
// cmd/kura-release-indexer/main.go's inline helper into a first-class package.
//
// Flag/env binding (the KURA_RELEASES_ prefix) is wired in cmd/kura-release-indexer; this package
...
// cmd/kura-release-indexer flags; Phase 1 adds binding + ingestion knobs.
type Config struct {
